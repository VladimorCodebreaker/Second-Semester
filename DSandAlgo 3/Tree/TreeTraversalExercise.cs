...
namespace DS_and_Algo_3.Tree
{
    ...
    internal class TreeTraversalExercise
    {
        ...
        public static void Run()
        {
            ...
            Console.SetIn(new System.IO.StreamReader(@"C:\\Meine_Codes\Visual_Studio_2019\Semester_2\DS_and_Algo_3\Tree\input_1.txt")); //../../Tree/input_1.txt
