...
namespace DS_and_Algo_3.BinaryTreeExample
{
    ...
    {
        // property to store the node's data could be a key and object pair
        private int data;
        public int Data
        {
            get { return data; }
        ...
        public TreeNode Find(int value)
        {
            ...
            // loop through this node and all of the children nodes
            while (currentNode != null)
            {
                ...
                else // otherwise if the value is less than the current node's data go to the left child node
                {
        ...
        {
            // value passed in matched node's data return the node
        ...
        {
            // if the value passed in is greater or equal to the data then insert to the right node
            if (value >= data)
            ...
            {// if the value passed in is less than the data then insert to the left node
                if (leftNode == null)
        ...
        public void InOrderTraversal()
        {
            ...
            // Then we go to teh right node wich will print itself as both its children are null
            if (rightNode != null)
        ...
        public int Height()
        {
            // return 1 when lead node is found
        ...
        public int NumberOfLeafNodes()
        {
            ...
            //recursively call NumOfLeadNodes returning 1 for each leaf found
            if (this.leftNode != null)
            {
